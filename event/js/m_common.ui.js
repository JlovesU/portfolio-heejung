...
window.addEventListener('load', () => {
    ...
    document.querySelector('.my-suggestion-swiper') && setSwiper({target: document.querySelector('.my-suggestion-swiper'), viewNum: 2.6, gap: 12});
	...
	let productDetailSwiper = new Swiper('.productdetail .wrap-swiper-list-product', {
        slidesPerView: 1,
		slidesPerColumn:4,
        // spaceBetween: 12,
        observer: true,
		...
		pagination: {
			el:'.productdetail .wrap-swiper-list-product .swiper-pagination'
		}
    });
